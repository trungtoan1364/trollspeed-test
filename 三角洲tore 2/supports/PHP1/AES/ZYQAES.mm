...
{
    const char* input = [key UTF8String];
...
+ (NSData *)aesEncryptOrDecrypt:(CCOperation)option data:(NSData *)data dataKey:(NSData *)key dataIv:(NSData *)iv mode:(int)mode{
    //key=[DF_KEYA dataUsingEncoding:NSUTF8StringEncoding];
    //iv=[DF_KEYC dataUsingEncoding:NSUTF8StringEncoding];
    iv       = [self dataFromHexString:@"00000000000000000000000000000000"];
