...
struct WidgetPreferencesView: View {
    ...
    func getFormattedDate(_ format: String) -> String {
        let locale = UserDefaults.standard.string(forKey: "dateLocale", forPath: "") ?? "en_US"
...
struct WeatherLocationView: View {
    ...
    func search() {
        if !searchString.isEmpty {
            let dateLocale = UserDefaults.standard.string(forKey: "dateLocale", forPath: "") ?? "en_US"
            let apiKey = UserDefaults.standard.string(forKey: "apiKey", forPath: "") ?? ""
