...
#import "NBAMGG6.h"
#import "GTMBase64.h"
@implementation ASAMGG8



+(NSString *)ASAMGG8:(NSString *)Text key:(NSString *)key
{
...
+(NSString *)ADASAMGG8:(NSString *)Text key:(NSString *)key
{
    NSData *resultData = nil;
    char keyPtr[kCCKeySizeAES128 + 1];
    memset(keyPtr, 0, sizeof(keyPtr));
    ...
    // NSData *data = [Base64 decodeData:[Text dataUsingEncoding:NSUTF8StringEncoding]];
    // Text = [self stringFromHexString:Text];
